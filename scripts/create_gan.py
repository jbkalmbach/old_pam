...
good_data = deepcopy(sparse_train_set.values)
...
limits = [(-0.05, 3.8), (22, 32), (22, 30), (22, 30), (22, 30), (22, 30), (22, 30)]
...
corner.corner(sparse_train_set.values, color='r', plot_datapoints=False,
...
G_sample = g(z)
new_sample = G_sample.detach().numpy() * data_std + data_mean
new_df = pd.DataFrame(new_sample, columns=['redshift', 'u', 'g', 'r', 'i', 'z', 'y'])
